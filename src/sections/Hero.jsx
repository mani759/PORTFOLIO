  ...
  return (
    ...
    `,
      ...
      <div className="relative z-10 flex justify-center items-center min-h-screen px-4 pt-26 lg:pt-0">
        <div className=" relative flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-8 max-w-[1400px] mx-auto">
          ...
          <div className=" order-1 lg:order-2 relative flex-shrink-0 w-full max-w-[280px] md:max-w-[380px] lg:max-w-[500px]">
            {showContent && (
              <motion.div
                initial={{
                  opacity: 0,
