    ...
    `,
      ...
      <div className="relative z-10 flex justify-center items-center min-h-screen">
        <div className=" relative">
          <div className="absolute right-full mr-10 top-1/2 -translate-y-1/2">
            {showContent && <SkillCat />}
          </div>

          <div className=" relative hidden  md:block w-[380px] lg:w-[550px] ">
            {showContent && (
              <motion.div
                initial={{
                  opacity: 0,
            ...
            <motion.img
              ...
              animate={{ y: [0, -15, 0], scale: showContent ? 1.2 : 1 }}
              transition={{
                duration: 10,
                repeat: Infinity,
                ease: easeInOut,
